   ...
   <body>
      ...
      <div class="main-wrapper"> 
         <div id="content-area" style="padding-top:14% !important">
            <h4 class="header_centered">Обратная связь</h4>
            <div class="block_wrapper">
               <label for="name_input">Ваше имя: </label><input id="name_input" maxlength=100 name="name" />
               <br><label for="email_input">Ваш e-mail: </label><input id="email_input" maxlength=100 name="email" />
               <br><label id="message_input_label" for="message_input">Сообщение: </label><textarea id="message_input" maxlength=1000 name="message"></textarea>
               <p><a id="send_button" href="javascript:void(0)" onclick="sendFeedback()" class="btn transparent blue"/>Отправить</a>
            </div>
         </div>
      </div>

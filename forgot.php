   ...
   <body>
      ...
      <div class="main-wrapper"> 
         <div id="content-area" style="padding-top:14% !important">
            <h4 class="header_centered">Восстановление пароля</h4>
            <div class="block_wrapper" style="width:75% !important;">
               <div id="password_alert" class="alert" style="width:67%; margin-left:138px; <?php if(isset($_GET["error"])) echo "display:block"; else echo ""; ?>">Ошибка: такого пользователя не существует</div>
               <form id="reset-password-form" action="reset.php" method="post"> 
                  <label for="email_input" class="neccesary">Ваш e-mail: </label><input id="email_input" maxlength=100 name="email" class="neccesary_input" />
                  <p><input id="restore_button" href="javascript:void(0)" class="btn transparent blue" type="submit" style="width:67% !important;" value="Выслать пароль" />
               </form>
            </div>
         </div>
      </div>
